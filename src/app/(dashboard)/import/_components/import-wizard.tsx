...
const MODULES: ModuleConfig[] = [
  ...
  },
  {
    ...
    instructions: [
      ...
      "total_costing is auto-computed as salary + tada + incentive + actual_vendor_costing (sales_promotion is tracked but excluded from the sum).",
    ],
    columns: [
      { name: "name", required: true },
      { name: "month", required: true },
      ...
      { name: "actual_commercial_project", required: true },
      { name: "actual_hotel_project", required: true },
      ...
      { name: "actual_vendor_costing", required: true },
