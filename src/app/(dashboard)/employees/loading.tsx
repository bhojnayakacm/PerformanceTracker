...
export default function EmployeesLoading() {
  return (
    <div className="flex h-full min-h-0 flex-col gap-4">
      ...
      {/* Toolbar */}
      <div className="shrink-0 flex items-center gap-3 rounded-2xl border border-slate-200/80 bg-white/85 p-3 backdrop-blur-md shadow-[0_1px_2px_rgba(15,23,42,0.04),0_12px_32px_-20px_rgba(79,70,229,0.25)]">
