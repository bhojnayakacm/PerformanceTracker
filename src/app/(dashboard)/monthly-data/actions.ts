      ...
      .upsert(
        {
          ...
          actual_commercial_project: data.actual_commercial_project,
          actual_hotel_project: data.actual_hotel_project,
          ...
          actual_vendor_costing: data.actual_vendor_costing,
